...
if (isset($_POST['new_password']) and isset($_POST['verify_password']) and isset($_POST['employeeId'])) {
    ...
    die('Invalid query: ' . mysql_error());
		...
		$body = "Your Password has been successfully reset. Please login again. http://awsportal.dev.sifworks.com/aws_portal";
		...
		if ($new_pwd == $verify_pwd) {
			echo "Your new password has been successfully changed. Please login again with new password.<br>";
